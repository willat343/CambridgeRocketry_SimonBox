...
public class ParachuteData extends RockPartsData{
    ...
    public void PopulateParachute(double d1,double d2,double d3,double d4,double d5,double d6, double d7, boolean b1, String s1){
        PackedLength = d1; PackedDiameter = d2; Mass = d3; Xp = d4;
        Area = d5; DragCoefficient = d6; Altitude = d7;
        apogee = b1;
        Name = s1;
        Body = false;
    ...
    public void BuildFromXML(Node Nin){
        ...
        PopulateParachute(Temp.DbyName("PackedLength"),Temp.DbyName("PackedDiameter"),Temp.DbyName("Mass"),Temp.DbyName("Xp"),Temp.DbyName("Area"),Temp.DbyName("DragCoefficient"),Temp.DbyName("Altitude"),Temp.BbyName("apogee"),Temp.SbyName("Name"));
        built=true;
    }
