...
public class ConeSecData extends RockPartsData {
    ...
    public void BuildFromXML(Node Nin){
        ...
        PopulateConicTrans(Temp.DbyName("length"),Temp.DbyName("UD"),Temp.DbyName("DD"),Temp.DbyName("RadPos"),Temp.DbyName("Thickness"),Temp.DbyName("Mass"),Temp.DbyName("Xp"),Temp.SbyName("Name"));
