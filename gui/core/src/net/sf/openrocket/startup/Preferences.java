...
public abstract class Preferences implements ChangeSource {
	...
	// extra camrocksim
	public static final String MONTE_CARLO_BOOL = "MonteCarloBool";
	public static final String MONTE_CARLO_INT = "MonteCarloInteger";
	...
	public final boolean getMonteCarloBool() {
		return this.getBoolean(MONTE_CARLO_BOOL, false);
	}
	
	public final void setMonteCarloBool(boolean isMonteCarlo) {
		this.putBoolean(MONTE_CARLO_BOOL, isMonteCarlo);
	}
	
	public final void setAtmosphereString(String newPath) {
		this.putString(ATMOSPHERE_STR, newPath);
	}
	
	public final String getAtmosphereString() {
		return this.getString(ATMOSPHERE_STR, "./Atmospheres/wpNoWind.xml");
	}
	
	public final void setMonteCarloInteger(double numberOfMonteCarlo) {
		this.putDouble(MONTE_CARLO_INT, numberOfMonteCarlo);
	}
	
	public final double getMonteCarloInteger() {
		return this.getDouble(MONTE_CARLO_INT, 50); // default
	}
