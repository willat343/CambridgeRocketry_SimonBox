...
public abstract class SymmetricComponent extends BodyComponent implements RadialParent {
	...
	public final double getAbsolutePosition() {
		...
		// look at previous component
		SymmetricComponent thisSymmetricComponent = this.getPreviousSymmetricComponent();
		
		// look at ALL previous components
		while (thisSymmetricComponent != null) {
			// if non-zero, get length and add to absolute position
			absolutePosition = absolutePosition + thisSymmetricComponent.getLength();
			
			// get the symmetric component before that!
			thisSymmetricComponent = thisSymmetricComponent.getPreviousSymmetricComponent();
		}
