...
public class Rocket extends RocketComponent {
	...
	public Rocket copyWithOriginalID() {
		...
		copy.flightConfigurationNames = (HashMap<String, String>) this.flightConfigurationNames.clone();
		copy.resetListeners();
	...
	public void loadFrom(Rocket r) {
		...
		this.flightConfigurationNames = (HashMap<String, String>) r.flightConfigurationNames.clone();
	...
	public RockPartsData getRockPartsData(Simulation inputSimulation) {
		// entire rocket is not returned.
		return null;
	}
	
	@Override
	public final double getAbsolutePosition() {
		// absolute position wrt nosecone is always 0!
		return 0;
	}
