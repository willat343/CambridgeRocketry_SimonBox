...
public class TrapezoidFinSet extends FinSet {
	...
	@Override
	public final RockPartsData getRockPartsData(Simulation thisSimulation) {
		// return RockPartsData conversion
		
		int thisNumberOfFins = this.getFinCount();
		double thisRootChord = this.getRootChord();
		double thisTipChord = this.getTipChord();
		double thisSpan = this.getSpan();
		double thisSweep = this.getSweep();
