...
public abstract class RocketComponent implements ChangeSource, Cloneable, Iterable<RocketComponent> {
	...
	/*
	 * this method returns the version of RockPartsData - or the best possible approximation
	 * 
	 */
	public abstract RockPartsData getRockPartsData(Simulation inputSimulation);
	
	/*
	 * a method to return the ABSOLUTE (measured from the nose-cone) for all objects..
	 * 
	 */
