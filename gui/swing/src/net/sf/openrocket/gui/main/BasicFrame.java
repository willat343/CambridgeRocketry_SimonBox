...
public class BasicFrame extends JFrame {
	...
	private panelCamRockSim thisPanelCamRockSim;
	...
	public BasicFrame(OpenRocketDocument document) {
		...
		// add these panels
		thisPanelCamRockSim = new panelCamRockSim(document);
		...
		// camrocksim simulations
		tabbedPane.addTab("Simulation", null, thisPanelCamRockSim);
	...
	private JComponent designTab() {
		...
		panel.add(button, "sizegroup buttons"); // "sizegroup buttons, aligny 65%"

		button = new JButton(actions.getMoveDownAction());
		panel.add(button, "sizegroup buttons"); // "sizegroup buttons, aligny 0%"

		button = new JButton(actions.getEditAction());
		panel.add(button, "sizegroup buttons");

		buttonNewStage = new JButton(actions.getNewStageAction());
		panel.add(buttonNewStage, "sizegroup buttons");
