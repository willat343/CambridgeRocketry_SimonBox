...
public class panelSimulation extends JPanel implements StateChangeListener {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5467500312467789009L;
	private static final Logger log = LoggerFactory.getLogger(panelSimulation.class);
	...
	*/
	...
	public panelSimulation(OpenRocketDocument doc) {
