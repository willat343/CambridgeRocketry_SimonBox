...
HandleInputFile::HandleInputFile(std::string FileName){
	...
	do{Fcase++;}while(Functions[Fcase].compare(FunctionName) != 0);
	...
	switch(Fcase){
		...
		case(3):
			...
			break;
		default:
			cout<<"Error: No simulation function found"<<endl;
			break;
	}
